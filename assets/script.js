...
// append buttons to the bottom of the lyrics with title of the song. Create an array in local storage to do this.
  ...
  // Appending Artist and Lyrics to HTML
  function generateLyrics(){
    // creates a main container to hold the song artist and title
    var lyricsContainer = document.createElement('div')
    lyricsContainer.setAttribute('class', 'lyrics')

    // console.log(lyricsContainer);
    // a wrapper for the name of the artist being searched
    var artistName = document.createElement('p');
    artistName.setAttribute('class', 'song-artist');
    ...
    // songTitle.append(lyricsApi(title));
    // songTitle.append(lyricsApi(data));
